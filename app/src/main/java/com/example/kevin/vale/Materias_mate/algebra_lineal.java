...
public class algebra_lineal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView = (ExpandableListView) findViewById(R.id.lista_expandible3);

        ExpandableListViewAdapter3 adapter = new ExpandableListViewAdapter3(algebra_lineal.this);

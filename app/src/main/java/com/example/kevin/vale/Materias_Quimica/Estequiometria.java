package com.example.kevin.vale.Materias_Quimica;
...
public class Estequiometria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView = (ExpandableListView) findViewById(R.id.lista_expandible_esteq);


        ExpandableListViewAdaptereste adapter = new ExpandableListViewAdaptereste(Estequiometria.this);
    ...
    public class ExpandableListViewAdaptereste extends BaseExpandableListAdapter {
        ...
        String[] gruponombres = {"Número de Avogadro","Disoluciones"};
